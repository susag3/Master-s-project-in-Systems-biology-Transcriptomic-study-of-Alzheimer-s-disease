...
file1 = 'PCG_ADout.txt'
file2 = 'PCG_Controut.txt'

f1 = open(file1)
f2 = open(file2)
allVals = open('AllValuesPCG.txt', 'w')
cFile = open('UseableCValuesPCG.txt', 'w')
dFile = open('UseableDValuesPCG.txt', 'w')
sFile = open('UseableSValuesPCG.txt', 'w')

print >> allVals, 'Gene 1', '\t', 'Gene2', '\t', 'rho_1', '\t', 'rho_2', '\t', 'C', '\t', 'S', '\t', 'D' 
...
for line1 in f1:
   ...
   #var2 = float(splitLine2[3])
    ...
    if (geneA != geneB):
        ...
        print >> allVals, geneA, '\t', geneB, '\t', rho1, '\t', rho2, '\t', cVal, '\t', sVal, '\t', dVal
